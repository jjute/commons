...
public class LoggerControl {
    ...
    private LoggerControl(String name, LoggerLevels levels, boolean currentContext, boolean additive) {
        ...
        loggerConfig = Log4jUtils.getOrCreateLoggerConfig(name, config, getLevel(LoggerLevels.Type.LOGGER), additive);
        logger = context.getLogger(name);

        loggerConfig.setAdditive(additive);
        loggerConfig.setLevel(getLevel(LoggerLevels.Type.LOGGER));
